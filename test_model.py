...
Uso:
  from test_model import test_gleason, test_isup, test_cancer_present
"""
...
def test_gleason(model, device, test_loader, criterion, gleason_mapping, test_primary=True, test_secondary=True):
  ...
  with torch.no_grad():
    ...
    if test_primary and test_secondary:
      ...
      return avg_loss, combined_accuracy, precision, recall, f1
      ...
      return avg_loss, primary_accuracy or secondary_accuracy, precision, recall, f1
